...
function addCmdToTable(_cmd) {
	...
	if (_cmd.logicalId == 'Model' || _cmd.logicalId == 'ups_serial' || _cmd.logicalId == 'ups_line' ||_cmd.logicalId == 'input_volt' || _cmd.logicalId == 'input_freq'|| _cmd.logicalId == 'output_volt' || _cmd.logicalId == 'output_freq'||_cmd.logicalId == 'output_power'||_cmd.logicalId == 'batt_charge'||_cmd.logicalId == 'batt_volt'||_cmd.logicalId == 'ups_load'||_cmd.logicalId == 'batt_runtime'||_cmd.logicalId == 'timer_shutdown') {
